...
SECRET_KEY = 'django-insecure-lqb3a0*m3ufc*a^y*kxa7cu8%a(1kfcd))0rqa4p(rzyir$-vi'
...
if os.getenv('DB_ENGINE', '').lower() == 'mysql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'metafit'),
...
# drf-yasg: do not link to Django's default /accounts/login/ (not used; this API is JWT-only).
SWAGGER_SETTINGS = {
